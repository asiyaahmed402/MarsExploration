...
import java.time.*;
/**
 * This class represents the thermal system of the shuttle
 * part names, life span, etc
 * */
public class ThermalSystem extends HealthCenter implements SpaceShuttleParts {
    ...
    public ThermalSystem(String name) {
        this.name = name;
    }
